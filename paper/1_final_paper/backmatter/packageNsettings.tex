...
\usepackage{natbib}
%\addbibresource{backmatter/wage_gap.bib}
...
citecolor=[RGB]{72,61,139},  % Link colors
pdftitle={Household Vulnerability And Environmental
Dependence in Rural Nepal}, % PDF title
pdfauthor={Sanjeev, Resham and Bipin}, % PDF Author
pdfsubject={Environmental economics}, % PDF Subject
pdfkeywords={Vulnerability, Environmental Dependence, Spatial Panel Data}, % PDF Keywords
pdfcreator={Sanjeev, Resham and Bipin}, % PDF Creator
}
...
%Following changes the figure and table to appendix format.
